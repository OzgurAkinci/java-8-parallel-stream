 ...
 * 
 */
@WebServiceClient(name = "ExpenseService", targetNamespace = "http://185.247.139.7:8182/thread-ws-server-application/", wsdlLocation = "http://185.247.139.7:8182/thread-cxf-jaxws-server/services/expenseService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://185.247.139.7:8182/thread-cxf-jaxws-server/services/expenseService?wsdl");
